      ...
      <div className="flex justify-between items-center">
        ...
        <div>
          <Link className="" to="/add-transaction">
            <div className="relative rounded px-6 py-1.5 overflow-hidden group bg-gray-800  hover:bg-gradient-to-r hover:from-blue-500 hover:to-blue-400  hover:ring-2 hover:ring-offset-2 hover:ring-blue-400 transition-all ease-out duration-300">
